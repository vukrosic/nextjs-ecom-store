                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li className="text-gray-400 hover:text-white cursor-pointer" onClick={() => scrollToSection('reviews')}>
                                Reviews
                            </li>
                        </ul>
                    </div>
                    <div className='space-y-6'>
                        ...
                        <div>
                            ...
                            <p className="text-gray-400">Excellence, Respect, and Enjoyment.</p>
                        </div>
                    </div>
                </div>
